...
import * as _indexOf      from './list/indexOf';
...
import * as _slice        from './list/slice';
import * as _tail         from './list/tail';
import * as _take         from './list/take';
import * as _transduce    from './list/transduce';
import * as _unfold       from './list/unfold';
import * as _union        from './list/union';
import * as _unionWith    from './list/unionWith';
import * as _uniq         from './list/uniq';
import * as _uniqBy       from './list/uniqBy';
import * as _uniqWith     from './list/uniqWith';
import * as _unnest       from './list/unnest';
import * as _update       from './list/update';
...
export const indexOf = _indexOf.indexOf;
...
export const unnest = _unnest.unnest;
export const update = _update.update;
