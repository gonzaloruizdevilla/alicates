...
var xfFor = function xfFor(obj) {
  return (0, _typeIsTransformer.isTransformer)(obj) ? obj : (0, _typeIsArrayLike.isArrayLike)(obj) ? arrayXf(obj) : isList(obj) ? listXf(obj) : typeof obj === 'string' ? stringXf(obj) : typeof obj === 'object' ? objectXf : throwError();
};
exports.xfFor = xfFor;