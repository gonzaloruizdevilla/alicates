...
var reduce = (0, _functionalCurry.curry)(function (fn, acc, arr) {
  return (fn = (0, _typeIsFunction.isFunction)(fn) ? new XfWrap(fn) : fn, (0, _typeIsArrayLike.isArrayLike)(arr) ? arrayReduce(fn, acc, arr, 0, arr.length) : (0, _objectHasMethod.hasMethod)('reduce', arr) ? arr.reduce(fn, acc) : null);
});
